...
public class WaveView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        VIEW_WIDTH = AppUtils.dip2px(context, 180);
        VIEW_HEIGHT = AppUtils.dip2px(context, 180);
...
//            WAVE_HEIGHT = (float) (VIEW_HEIGHT / 50);
            ...
            int startX = 0;
            Log.i(TAG, "begin point (" + AppUtils.px2dip(mContext, startX) + " , " + AppUtils.px2dip(mContext, dy) + ")");
            ...
            SPEED_NORMAL = (AppUtils.px2dip(mContext, VIEW_WIDTH) / 20);
...
//        Log.i("wusy","test v : y " +shadpointList.get(0).y);
    ...
    private int getRealWidthMeasureSpec(int widthMeasureSpec) {
        ...
        if (mode == MeasureSpec.AT_MOST) {
            Log.i(TAG, "AT_MOST width :" + AppUtils.px2dip(mContext, widthSize));//warp
//            VIEW_WIDTH = widthSize;
        } else if (mode == MeasureSpec.EXACTLY) {
            Log.i(TAG, "EXACTLY width :" + AppUtils.px2dip(mContext, widthSize));
            VIEW_WIDTH = widthSize;
        } else if (mode == MeasureSpec.UNSPECIFIED) {
            Log.i(TAG, "UNSPECIFIED width :" + AppUtils.px2dip(mContext, widthSize));
//            VIEW_WIDTH = VIEW_WIDTH_TMP;
    ...
    private int getRealHeightMeasureSpec(int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.AT_MOST) {
            Log.i(TAG, "AT_MOST heitht :" + AppUtils.px2dip(mContext, heightSize));
//            VIEW_HEIGHT = heightSize;
        } else if (mode == MeasureSpec.EXACTLY) {
            Log.i(TAG, "EXACTLY heitht :" + AppUtils.px2dip(mContext, heightSize));
            VIEW_HEIGHT = heightSize;
        } else if (mode == MeasureSpec.UNSPECIFIED) {
            Log.i(TAG, "UNSPECIFIED heitht :" + AppUtils.px2dip(mContext, heightSize));
